...
WS.sendRequest(findTestObject('Dummy Example/All Employees'))

WS.sendRequest(findTestObject('Dummy Example/Specefic Employee'))

WS.sendRequest(findTestObject('Dummy Example/Delete Employee'))
